    ...
    void validateSchemaPassesWhenRequiredColumnsExist() {
        ...
        when(jdbcTemplate.queryForList(
                ...
                .thenReturn(List.of(
                        ...
                        Map.of("column_name", "userAgent", "data_type", "character varying", "is_nullable", "YES"),
                        Map.of("column_name", "deviceLabel", "data_type", "character varying", "is_nullable", "YES"),
                        Map.of("column_name", "ipAddress", "data_type", "character varying", "is_nullable", "YES"),
                        Map.of("column_name", "lastUsedAt", "data_type", "timestamp without time zone", "is_nullable", "YES"),
